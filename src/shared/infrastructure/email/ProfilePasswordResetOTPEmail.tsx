...
export interface ProfilePasswordResetOTPEmailProps {
  name: string;
  code: string;
}
...
export const ProfilePasswordResetOTPEmail: React.FC<ProfilePasswordResetOTPEmailProps> = ({
  name,
  code,
}: ProfilePasswordResetOTPEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>
        {`Your password reset OTP is ${code}. Use it to update your password securely.`}
      </Preview>
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.description}>
              ...
              code (OTP) below to complete the password reset process. This code is
...
export default ProfilePasswordResetOTPEmail;
