...
export interface InviteSupervisorEmailProps {
  name: string;
  token: string;
  baseUrl: string;
  jobTitle?: string;
...
export const InviteSupervisorEmail: React.FC<InviteSupervisorEmailProps> = ({
  name,
  token,
  baseUrl,
  jobTitle,
  departmentNames,
}: InviteSupervisorEmailProps) => {
  ...
  return (
    <Html>
      <Head />
      <Preview>
        {`You're invited to join as a Supervisor. Complete your registration to get started!`}
      </Preview>
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.description}>
              You have been invited to join as a <strong>Supervisor</strong> on
              our platform. We're excited to have you on board! Please complete
              your registration to access your account and start managing your
              team.
            </Text>

            {/* Invitation Details Card */}
            {(jobTitle || departmentNames?.length) && (
            ...
            <div style={styles.featuresList}>
              ...
              <ul style={styles.featuresListItems}>
                ...
                <li style={styles.featuresListItem}>
                  Manage your team and departments
                </li>
              </ul>
            </div>
          </Section>
...
export default InviteSupervisorEmail;
