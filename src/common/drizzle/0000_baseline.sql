...
CREATE TABLE "departments" (
	...
	"is_exposed_to_tv_content" boolean DEFAULT false NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "task_delegation_submissions" (
	...
	"forwarded_to_supervisor_id" uuid,
...
CREATE TABLE "tasks" (
	...
	"creator_id" uuid,
	"days_before_deadline_reminder" integer
);
--> statement-breakpoint
...
ALTER TABLE "attachment_group_members" ADD CONSTRAINT "attachment_group_members_attachment_group_id_fkey" FOREIGN KEY ("attachment_group_id") REFERENCES "public"."attachment_groups"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "task_delegation_submissions" ADD CONSTRAINT "task_delegation_submissions_forwarded_to_supervisor_id_fkey" FOREIGN KEY ("forwarded_to_supervisor_id") REFERENCES "public"."supervisors"("id") ON DELETE set null ON UPDATE cascade;--> statement-breakpoint
...
CREATE INDEX "activity_logs_occurred_at_idx" ON "activity_logs" USING btree ("occurred_at");--> statement-breakpoint
...
CREATE UNIQUE INDEX "admins_user_id_key" ON "admins" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "attachment_group_members_attachment_group_id_idx" ON "attachment_group_members" USING btree ("attachment_group_id");--> statement-breakpoint
CREATE INDEX "attachment_group_members_member_id_idx" ON "attachment_group_members" USING btree ("member_id");--> statement-breakpoint
CREATE INDEX "attachment_group_members_department_id_index" ON "attachment_group_members" USING btree ("department_id");--> statement-breakpoint
CREATE INDEX "attachment_groups_created_by_id_idx" ON "attachment_groups" USING btree ("created_by_id");--> statement-breakpoint
CREATE INDEX "attachment_groups_key_idx" ON "attachment_groups" USING btree ("key");--> statement-breakpoint
CREATE INDEX "_AttachmentToAttachmentGroup_B_index" ON "_AttachmentToAttachmentGroup" USING btree ("B");--> statement-breakpoint
CREATE INDEX "attachments_cloned_idx" ON "attachments" USING btree ("cloned");--> statement-breakpoint
CREATE INDEX "attachments_guest_id_idx" ON "attachments" USING btree ("guest_id");--> statement-breakpoint
CREATE INDEX "attachments_is_global_idx" ON "attachments" USING btree ("is_global");--> statement-breakpoint
CREATE INDEX "attachments_target_id_idx" ON "attachments" USING btree ("target_id");--> statement-breakpoint
CREATE INDEX "attachments_user_id_idx" ON "attachments" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "conversations_guest_id_is_deleted_idx" ON "conversations" USING btree ("guest_id","is_deleted");--> statement-breakpoint
CREATE INDEX "_DepartmentToSupervisor_B_index" ON "_DepartmentToSupervisor" USING btree ("B");--> statement-breakpoint
CREATE INDEX "departments_parent_id_idx" ON "departments" USING btree ("parent_id");--> statement-breakpoint
CREATE UNIQUE INDEX "drivers_licensing_number_key" ON "drivers" USING btree ("licensing_number");--> statement-breakpoint
CREATE INDEX "drivers_supervisor_id_idx" ON "drivers" USING btree ("supervisor_id");--> statement-breakpoint
CREATE UNIQUE INDEX "drivers_user_id_key" ON "drivers" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "employee_requests_requested_by_supervisor_id_idx" ON "employee_requests" USING btree ("requested_by_supervisor_id");--> statement-breakpoint
CREATE INDEX "employee_requests_resolved_by_admin_id_status_idx" ON "employee_requests" USING btree ("resolved_by_admin_id","status");--> statement-breakpoint
CREATE INDEX "employee_sub_departments_department_id_idx" ON "employee_sub_departments" USING btree ("department_id");--> statement-breakpoint
CREATE UNIQUE INDEX "employee_sub_departments_employee_id_department_id_key" ON "employee_sub_departments" USING btree ("employee_id","department_id");--> statement-breakpoint
CREATE INDEX "employee_sub_departments_employee_id_idx" ON "employee_sub_departments" USING btree ("employee_id");--> statement-breakpoint
CREATE UNIQUE INDEX "employees_user_id_key" ON "employees" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "exports_type_idx" ON "exports" USING btree ("type");--> statement-breakpoint
CREATE UNIQUE INDEX "guests_email_key" ON "guests" USING btree ("email");--> statement-breakpoint
CREATE UNIQUE INDEX "guests_phone_key" ON "guests" USING btree ("phone");--> statement-breakpoint
CREATE INDEX "knowledge_chunks_department_id_idx" ON "knowledge_chunks" USING btree ("department_id");--> statement-breakpoint
CREATE INDEX "knowledge_chunks_point_id_idx" ON "knowledge_chunks" USING btree ("point_id");--> statement-breakpoint
CREATE INDEX "messages_conversation_id_idx" ON "messages" USING btree ("conversation_id");--> statement-breakpoint
CREATE UNIQUE INDEX "profile_pictures_user_id_key" ON "profile_pictures" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "promotions_created_by_admin_id_is_active_created_by_supervi_idx" ON "promotions" USING btree ("created_by_admin_id","is_active","created_by_supervisor_id");--> statement-breakpoint
CREATE INDEX "push_subscriptions_user_id_idx" ON "push_subscriptions" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "question_interactions_guest_id_idx" ON "question_interactions" USING btree ("guest_id");--> statement-breakpoint
CREATE UNIQUE INDEX "question_interactions_question_id_guest_id_key" ON "question_interactions" USING btree ("question_id","guest_id");--> statement-breakpoint
CREATE INDEX "question_interactions_question_id_idx" ON "question_interactions" USING btree ("question_id");--> statement-breakpoint
CREATE INDEX "question_views_guest_id_idx" ON "question_views" USING btree ("guest_id");--> statement-breakpoint
CREATE UNIQUE INDEX "question_views_question_id_guest_id_key" ON "question_views" USING btree ("question_id","guest_id");--> statement-breakpoint
CREATE INDEX "question_views_question_id_idx" ON "question_views" USING btree ("question_id");--> statement-breakpoint
CREATE INDEX "questions_creator_supervisor_id_idx" ON "questions" USING btree ("creator_supervisor_id");--> statement-breakpoint
CREATE INDEX "questions_department_id_idx" ON "questions" USING btree ("department_id");--> statement-breakpoint
CREATE INDEX "questions_department_id_views_idx" ON "questions" USING btree ("department_id","views");--> statement-breakpoint
CREATE INDEX "questions_views_idx" ON "questions" USING btree ("views");--> statement-breakpoint
CREATE INDEX "recipient_notifications_notification_id_idx" ON "recipient_notifications" USING btree ("notification_id");--> statement-breakpoint
CREATE INDEX "recipient_notifications_seen_idx" ON "recipient_notifications" USING btree ("seen");--> statement-breakpoint
CREATE INDEX "recipient_notifications_user_id_idx" ON "recipient_notifications" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "refresh_tokens_token_idx" ON "refresh_tokens" USING btree ("token");--> statement-breakpoint
CREATE INDEX "retrieved_chunks_knowledge_chunk_id_idx" ON "retrieved_chunks" USING btree ("knowledge_chunk_id");--> statement-breakpoint
CREATE UNIQUE INDEX "retrieved_chunks_message_id_key" ON "retrieved_chunks" USING btree ("message_id");--> statement-breakpoint
CREATE INDEX "supervisors_user_id_idx" ON "supervisors" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "supervisors_user_id_key" ON "supervisors" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "support_ticket_answers_answerer_supervisor_id_answerer_empl_idx" ON "support_ticket_answers" USING btree ("answerer_supervisor_id","answerer_employee_id","answerer_admin_id");--> statement-breakpoint
CREATE UNIQUE INDEX "support_ticket_answers_support_ticket_id_key" ON "support_ticket_answers" USING btree ("support_ticket_id");--> statement-breakpoint
CREATE INDEX "support_ticket_interactions_anonymous_id_idx" ON "support_ticket_interactions" USING btree ("anonymous_id");--> statement-breakpoint
CREATE INDEX "support_ticket_interactions_guest_id_idx" ON "support_ticket_interactions" USING btree ("guest_id");--> statement-breakpoint
CREATE INDEX "support_ticket_interactions_support_ticket_id_idx" ON "support_ticket_interactions" USING btree ("support_ticket_id");--> statement-breakpoint
CREATE UNIQUE INDEX "support_ticket_interactions_support_ticket_id_key" ON "support_ticket_interactions" USING btree ("support_ticket_id");--> statement-breakpoint
CREATE INDEX "idx_support_tickets_cursor" ON "support_tickets" USING btree ("created_at" DESC NULLS LAST,"id" DESC NULLS LAST);--> statement-breakpoint
...
CREATE UNIQUE INDEX "support_tickets_code_key" ON "support_tickets" USING btree ("code");--> statement-breakpoint
CREATE INDEX "support_tickets_department_id_idx" ON "support_tickets" USING btree ("department_id");--> statement-breakpoint
CREATE INDEX "support_tickets_status_idx" ON "support_tickets" USING btree ("status");--> statement-breakpoint
CREATE INDEX "task_delegation_submissions_delegation_id_idx" ON "task_delegation_submissions" USING btree ("delegation_id");--> statement-breakpoint
CREATE INDEX "task_delegation_submissions_performer_admin_id_idx" ON "task_delegation_submissions" USING btree ("performer_admin_id");--> statement-breakpoint
CREATE INDEX "task_delegation_submissions_performer_employee_id_idx" ON "task_delegation_submissions" USING btree ("performer_employee_id");--> statement-breakpoint
CREATE INDEX "task_delegation_submissions_performer_supervisor_id_idx" ON "task_delegation_submissions" USING btree ("performer_supervisor_id");--> statement-breakpoint
CREATE INDEX "task_delegation_submissions_reviewed_by_admin_id_reviewed_b_idx" ON "task_delegation_submissions" USING btree ("reviewed_by_admin_id","reviewed_by_supervisor_id");--> statement-breakpoint
CREATE INDEX "task_delegation_submissions_status_idx" ON "task_delegation_submissions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "task_delegations_assignee_id_idx" ON "task_delegations" USING btree ("assignee_id");--> statement-breakpoint
CREATE INDEX "task_delegations_delegator_id_idx" ON "task_delegations" USING btree ("delegator_id");--> statement-breakpoint
CREATE INDEX "task_delegations_status_idx" ON "task_delegations" USING btree ("status");--> statement-breakpoint
CREATE INDEX "task_delegations_target_sub_department_id_idx" ON "task_delegations" USING btree ("target_sub_department_id");--> statement-breakpoint
CREATE INDEX "task_delegations_task_id_idx" ON "task_delegations" USING btree ("task_id");--> statement-breakpoint
CREATE INDEX "task_presets_assigner_id_idx" ON "task_presets" USING btree ("assigner_id");--> statement-breakpoint
CREATE INDEX "task_presets_assigner_role_idx" ON "task_presets" USING btree ("assigner_role");--> statement-breakpoint
CREATE INDEX "task_presets_name_idx" ON "task_presets" USING btree ("name");--> statement-breakpoint
CREATE INDEX "task_reminders_task_id_index" ON "task_reminders" USING btree ("task_id");--> statement-breakpoint
CREATE INDEX "task_submissions_performer_admin_id_idx" ON "task_submissions" USING btree ("performer_admin_id");--> statement-breakpoint
CREATE INDEX "task_submissions_performer_employee_id_idx" ON "task_submissions" USING btree ("performer_employee_id");--> statement-breakpoint
CREATE INDEX "task_submissions_performer_supervisor_id_idx" ON "task_submissions" USING btree ("performer_supervisor_id");--> statement-breakpoint
CREATE INDEX "task_submissions_reviewed_by_admin_id_reviewed_by_superviso_idx" ON "task_submissions" USING btree ("reviewed_by_admin_id","reviewed_by_supervisor_id");--> statement-breakpoint
...
CREATE INDEX "idx_tasks_cursor" ON "tasks" USING btree ("created_at" DESC NULLS LAST,"id" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "tasks_assignee_id_idx" ON "tasks" USING btree ("assignee_id");--> statement-breakpoint
CREATE INDEX "tasks_assigner_admin_id_idx" ON "tasks" USING btree ("assigner_admin_id");--> statement-breakpoint
CREATE INDEX "tasks_assigner_supervisor_id_idx" ON "tasks" USING btree ("assigner_supervisor_id");--> statement-breakpoint
CREATE INDEX "tasks_priority_idx" ON "tasks" USING btree ("priority");--> statement-breakpoint
CREATE INDEX "tasks_target_department_id_idx" ON "tasks" USING btree ("target_department_id");--> statement-breakpoint
CREATE INDEX "tasks_target_sub_department_id_idx" ON "tasks" USING btree ("target_sub_department_id");--> statement-breakpoint
CREATE UNIQUE INDEX "ticket_answers_ticket_id_key" ON "ticket_answers" USING btree ("ticket_id");--> statement-breakpoint
CREATE INDEX "tickets_department_id_idx" ON "tickets" USING btree ("department_id");--> statement-breakpoint
CREATE INDEX "tickets_guest_id_idx" ON "tickets" USING btree ("guest_id");--> statement-breakpoint
CREATE INDEX "tickets_point_id_is_auto_generated_idx" ON "tickets" USING btree ("point_id","is_auto_generated");--> statement-breakpoint
CREATE UNIQUE INDEX "tickets_ticket_code_key" ON "tickets" USING btree ("ticket_code");--> statement-breakpoint
CREATE INDEX "translations_lang_idx" ON "translations" USING btree ("lang");--> statement-breakpoint
CREATE INDEX "translations_target_id_idx" ON "translations" USING btree ("target_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "vehicle_licenses_vehicle_id_key" ON "vehicle_licenses" USING btree ("vehicle_id");--> statement-breakpoint
CREATE INDEX "vehicles_driver_id_status_idx" ON "vehicles" USING btree ("driver_id","status");--> statement-breakpoint
CREATE INDEX "violations_driver_id_idx" ON "violations" USING btree ("driver_id");--> statement-breakpoint
CREATE INDEX "violations_rule_id_is_paid_idx" ON "violations" USING btree ("rule_id","is_paid");--> statement-breakpoint
CREATE INDEX "violations_vehicle_id_idx" ON "violations" USING btree ("vehicle_id");