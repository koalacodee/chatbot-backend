...
export const employeeSubDepartmentsRelations = relations(
  employeeSubDepartments,
  ({ one }) => ({
    department: one(departments, {
...
export const supervisorsRelations = relations(supervisors, ({ one, many }) => ({
  ...
  tasks: many(tasks),
  taskDelegations: many(taskDelegations),
  taskDelegationSubmissions_performerSupervisorId: many(
    taskDelegationSubmissions,
    {
      relationName:
        'taskDelegationSubmissions_performerSupervisorId_supervisors_id',
    },
  ),
  taskDelegationSubmissions_reviewedBySupervisorId: many(
    taskDelegationSubmissions,
    {
      relationName:
        'taskDelegationSubmissions_reviewedBySupervisorId_supervisors_id',
    },
  ),
  departmentToSupervisors: many(departmentToSupervisor),
}));
...
export const profilePicturesRelations = relations(
  profilePictures,
  ({ one }) => ({
    user: one(users, {
...
export const attachmentGroupsRelations = relations(
  attachmentGroups,
  ({ one, many }) => ({
    user: one(users, {
...
export const employeeRequestsRelations = relations(
  employeeRequests,
  ({ one }) => ({
    supervisor: one(supervisors, {
...
export const recipientNotificationsRelations = relations(
  recipientNotifications,
  ({ one }) => ({
...
export const retrievedChunksRelations = relations(
  retrievedChunks,
  ({ one }) => ({
    knowledgeChunk: one(knowledgeChunks, {
...
export const supportTicketInteractionsRelations = relations(
  supportTicketInteractions,
  ({ one }) => ({
    guest: one(guests, {
...
export const supportTicketAnswersRelations = relations(
  supportTicketAnswers,
  ({ one }) => ({
    admin: one(admins, {
...
export const vehicleLicensesRelations = relations(
  vehicleLicenses,
  ({ one }) => ({
...
export const questionInteractionsRelations = relations(
  questionInteractions,
  ({ one }) => ({
    question: one(questions, {
...
export const violationRulesRelations = relations(
  violationRules,
  ({ many }) => ({
    violations: many(violations),
  }),
...
export const departmentToSupervisorRelations = relations(
  departmentToSupervisor,
  ({ one }) => ({
    department: one(departments, {
...
export const attachmentToAttachmentGroupRelations = relations(
  attachmentToAttachmentGroup,
  ({ one }) => ({
...
export const attachmentGroupMembersRelations = relations(
  attachmentGroupMembers,
  ({ one }) => ({
    attachmentGroup: one(attachmentGroups, {
      fields: [attachmentGroupMembers.attachmentGroupId],
      references: [attachmentGroups.id],
    }),
  }),
);
